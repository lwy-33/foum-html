...
<!--            <img class="circleImg" src="D:\userImage\userImage\1.png">-->
          ...
          <div  style="height: 90% ">
            <!--        导航栏-->
            <el-menu default-active="1-4-1" class="el-menu-vertical-demo backclass" id="back" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
              <div v-for="game in games" @click="gameType(game.gameId)"><template  class=""><el-submenu  :index="game.gameId">
                    <span slot="title">{{ game.gameName }}</span>
              </el-submenu></template></div>

<!--              <div @click="wzry"><el-submenu  class="back2"  index="2">-->
<!--                <template  class="">-->
<!--                  <span slot="title">英雄联盟</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back3"  index="3">-->
<!--                <template  class="">-->
<!--                  <span slot="title">和平精英</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back6"  index="6">-->
<!--                <template  class="">-->
<!--                  <span slot="title">我的世界</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back7"  index="7">-->
<!--                <template  class="">-->
<!--                  <span slot="title">狼人杀</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back8"  index="8">-->
<!--                <template  class="">-->
<!--                  <span slot="title">崩坏三</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back9"  index="9">-->
<!--                <template  class="">-->
<!--                  <span slot="title">元神</span>-->
<!--                </template>-->
<!--              </el-submenu></div>-->
<!--              <div @click="wzry"><el-submenu  class="back10"  index="10">-->
<!--              <template  class="">-->
...
<!--                  </template>-->
                        ...
                        <div  v-for="p in titleList"  style="margin-top: 14px" >
                          ...
                          <el-card class="box-card">
                            ...
                            <a style="float: right"><img class="dzpl" src="./../images/comment.png"></a>
                            <!--                      点赞-->
                            <p class="dzplC">{{p.title.thumbsCount}}</p>
                            <a v-show="p.likeOrNot" style="float: right"><img class="dzpl" src="./../images/Thumbs.png"></a>
                            <a v-show="!p.likeOrNot" style="float: right"><img class="dzpl" src="./../images/noThumbs.png"></a>
                          </el-card>
